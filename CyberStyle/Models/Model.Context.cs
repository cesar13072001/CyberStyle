...
namespace CyberStyle.Models
{
    ...
    public partial class ciberstyleEntities : DbContext
    {
        ...
        public virtual ObjectResult<listar_fecha_Result> listar_fecha(string fecha)
        {
            var fechaParameter = fecha != null ?
                new ObjectParameter("fecha", fecha) :
                new ObjectParameter("fecha", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<listar_fecha_Result>("listar_fecha", fechaParameter);
        }
    
        public virtual ObjectResult<listar_compras_Result> listar_compras()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<listar_compras_Result>("listar_compras");
        }
    }
}
